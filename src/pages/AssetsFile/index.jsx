    ...
    return (
      ...
      <div className="pic1">
        <p> IMAGE 1.size:450 x 552 px resolution 72ppi.
            IMAGE.1a size:700 x 866 px resolution 72ppi.
        <hr className="new1"></hr>
          ...
          The  Bonwit's letters in the 1st image have been cleaned
          up of extraneous marks.
        </p>
      ...
      from the photograph at a size of 1005 x 2121 px.Saved image.</p>
      <p>3.Duplicate the image and re-size that to 500 x 1055px.Still quite big.Saved Image.</p>
      <p>4.Duplicate and re-size again to 250 x 525px.Saved Image.</p>
      <p>5.Posterize the image and saved.</p>
      <p>6.Duplicate image and use eraser tool,brushes and paint bucket to get to stage 3.Saved Image.</p>
      <p>7.Duplicate and re-size image to portrait size 420 x 420 px.Saved Image.</p>
      </div>
      </div>
      <div className="pic2">
      ...
      <p>5.Duplicated,re-sized and saved to make several different sized copies.</p>
      ...
      <div className="pic4">
        <p> Image 4:A similar process to the way the cat image
           was produced was utilised here for the club symbol. </p>
      </div>
      <div className="pic5">
        <p>IMAGE:5 Walking a tightrope.</p>
        <p>This seems relevant here as I have been walking a tight rope
           between the grungy black and white photographic images from the 1950's,
           with hand drawn elements and the
          modern hi-tech way of producing images on a computer. 
          Trying to keep the integrity of the original images as well
          as adapting them with so many possibilities and utilising the 
          Black ops font.It's hard to know when to stop tweaking.
          This image might or might not be utilised.
          I've been having a lot of fun!.</p>
          </div>
          <div className="pic6">
